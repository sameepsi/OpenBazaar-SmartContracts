 ...
 * Burning techniques will be decided later on. For now standard impl
 */
...
//Minting mechanics will be decided later on. For now standard implementation
 ...
 * @dev Token representing OpenBazaar.
 */
contract OpenBazaarToken is BurnableToken, MintableToken {
    string public name ;
